...
type LevelLoggable = Record<LogLevel, (message: string | Stringable, context: object) => void>;
type Loggable = Record<'log', (level: LogLevel, message: string | Stringable, context: object) => void>;
/**
